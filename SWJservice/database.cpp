...
//{
//    QSqlQuery query;
//    bool success=query.exec("CREATE TABLE account (id int NOT NULL primary key auto_increment,username VARCHAR(10) NOT NULL , password VARCHAR(10) NOT NULL,sex VARCHAR(10),birthday VARCHAR(10),icon VARCHAR(50))");
//    if(success)
