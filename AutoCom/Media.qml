                ...
                Row {
                    ...
                    Text {
                        ...
                        text: parent.currentTime(
                                  player.position) + "/" + parent.currentTime(
                                  player.duration)
                        color: "white"
                    }
                    //时间格式化
        ...
        Column {
            ...
            ButtonImage {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        if (dian.state == "BORING")
                            dian.state = "LIKE"
                        else if (dian.state == "LIKE")
                            dian.state = "BORING"
                    }
                }
            }
            ButtonImage {
                ...
                height: 50
                tooltip: "评论"
                iconImage: "./Images/p.png"
            }
            ButtonImage {
                width: 80
                height: 50
                tooltip: "转发"
                iconImage: "./Images/z.png"
            }
        }
    }
}
